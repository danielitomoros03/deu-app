...
#PROGRAMAS1 PROGRAMAS REGIONALES
  ...
  },
  {
    ...
    group: "programa1",
    subgroup: "objectives",
    short_description: "Identificar las necesidades de desarrollo social y económico de las comunidades locales y regionales.\n
 ...
 Fortalecer el trabajo y la vinculación con las diversas comunidades locales y regionales, pertenecientes a los diferentes sectores."
  },
  {
    ...
    group: "programa1",
    subgroup: "functions",
    short_description: "Realizar estudios y diagnósticos para identificar las necesidades específicas de las comunidades en las que se implementarán los programas.\n
 ...
 Los Programas Regionales deben fortalecer las redes de trabajo con otras instituciones que trabajan con las comunidades."
...

  {
    ...
    group: "programa1",
    subgroup: "contact",
    short_description: "Coordinador: JUAN ALBERTO TINEO MALAVÉ.\n
 Tlf: (0412) 091-6710.\n
...
#PROGRAMA2
...

  {
    ...
    group: "programa2",
    subgroup: "objectives",
    short_description: "Identificar oportunidades de vinculación entre la universidad y las comunidades, los sectores público y privado, y las organizaciones de la sociedad civil, coordinando con las Facultades el levantamiento de información sobre proyectos, productos y servicios universitarios.\n 
 ...
 Divulgar los resultados de los proyectos universitarios a través de diversos canales de comunicación."
  ...
  group: "programa2",
  subgroup: "functions",
  short_description: "Identificar, en trabajo conjunto a las facultades, las oportunidades de colaboración entre la Universidad y las comunidades, los sectores público y privado, y las organizaciones de la sociedad civil.\n
 ...
 Generar publicaciones científicas y técnicas sobre los resultados de los proyectos universitarios."
...

  {
    ...
    group: "programa2",
    subgroup: "contact",
    short_description: "Coordinador: RAFAEL VIELMA.\n
 Tlf: (0212) 605-3964.\n
 Correo: deu.depecp@gmail.com"
  ...
  },
  {
    ...
    group: "departamento1",
    subgroup: "objectives",
    short_description: " Gestionar el establecimiento de relaciones con organizaciones públicas, privadas, comunitarias y del tercer sector, dentro de los planes estratégicos de la Dirección.\n
  ...
  },
  {
    ...
    group: "departamento1", 
    subgroup: "functions",
    short_description: " Elaborar y coordinar planes y programas de comunicación internos y externos para proyectar la imagen de la Dirección de Extensión Universitaria.\n
  ...
  },
  {
    ...
    group: "departamento1",
    subgroup: "contact",
    short_description: "Coordinador:  AGNEDY MATERANO.\n
    Tlf: (0212) 605-3908.\n
  ...
  #DEPARTAMENTO2 EXTENSIÓN SOCIAL UNIVERSITARIA
  {
    ...
    group: "departamento2",
    subgroup:"description",
    short_description: "La propuesta de cambio de nombre del Departamento de Proyectos de Extensión y Programas Estudiantiles, a Departamento de Extensión Social Universitaria, focaliza la función social de la extensión, ampliando la perspectiva de lo meramente asistencial hacia el bienestar social, el fortalecimiento del tejido social y la proyección de la Extensión Universitaria como función ejecutora entre los fondos de acción, inversión y desarrollo social.
   ...
   \n\nVISIÓN\nInnovar en la promoción de la gestión social universitaria, construyendo puentes sólidos entre la universidad y la comunidad para un desarrollo sostenible, consolidando la presencia de la UCV a lo interno y externo."
    ...
    group: "departamento2",
    subgroup: "objectives",
    short_description: "Facilitar el acceso a formaciones no académicas dirigidas a la actualización y el mejoramiento profesional de toda la comunidad universitaria.\n
    ...
    },
  {
    ...
    group: "departamento2", 
    subgroup: "functions",
    short_description:"Diseñar, elaborar y coordinar programas y proyectos que tengan que ver con la proyección extensionista universitaria.\n
 ...
 Las demás funciones que le confiere las leyes y reglamentos, normas y su supervisor inmediato."
  },
  {
    ...
    group: "departamento2",
    subgroup: "contact",
    short_description:"Coordinador: MAYERKIS HIDALGO.\n
    Tlf: (0412) 5502096.\n
  ...
  #DEPARTAMENTO3 EDUCACIÓN CONTINUA Y PERMANENTE
  {
    ...
    group: "departamento3",
    subgroup: "description",
    short_description:"El Departamento de Educación Continua y Permanente (ECP) es el responsable de la mayor fuente de ingresos por concepto de avales y cursos, talleres, programas y diplomados no acreditables ni conducentes a título. Es el departamento que abre puertas a la actualización continua de profesionales, la comunitaria y entre otras.
  ...
  {    name: "Funciones",
    group: "departamento3", 
    subgroup: "functions",
    short_description:"Formular y evaluar la factibilidad de realizar programas y proyectos de orientación educativa.\n
 ...
 Las demás funciones que le confieren las leyes y reglamentos, normas y su supervisor inmediato."
  ...
  {  
    ...
    group: "departamento3",
    subgroup: "contact",
    short_description:"Coordinador: MARIA ISABEL RAMOS.\n
    Tlf: (0212) 605-3919.\n
    Correo: deu.depecp@gmail.com"
},
...
},
{
  ...
  group: "departamento4",
  subgroup: "objectives",
  short_description:"Planificación, diseño, ejecución y evaluación de programas y proyectos de extensión universitaria en las localidades y regiones del país.\n
...
},
{
  ...
  group: "departamento4",
  subgroup: "contact",
  short_description:"Coordinador: ELIZABETH PIÑA.\n
 Tlf: (0212) 605-4397.\n
